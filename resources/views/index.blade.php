        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
            <div
                ...
                <div class="md:w-1/4 p-6 flex items-center justify-center bg-white text-[#25345d] relative overflow-hidden">
                    <div class="absolute inset-0 bg-white/0 group-hover:bg-white/10 transition-colors duration-300">
                    </div>
                    <h3 class="font-bold text-xl md:text-2xl tracking-wider text-center relative z-10">UMUM<br>ICU, UGD,
                        OK</h3>
                </div>
